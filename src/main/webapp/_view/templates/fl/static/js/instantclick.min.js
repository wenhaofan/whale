...
var InstantClick = function (d, r) {
    var B = navigator.userAgent, E = "createTouch" in d, C, e, l, c = {}, G, L = false, h = false, u = false, A = false, I = {}, a = false, o = false, g = [], x, F, v, y = {
        fetch: [],
        receive: [],
        wait: [],
        change: []
    ...
    var H = function () {
        ...
        function S() {
            ...
            var ad = "orientation" in window && Math.abs(orientation) == 90, ac = innerWidth / screen[ad ? "height" : "width"] * 2;
